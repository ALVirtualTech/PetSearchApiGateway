...
import ru.airlightvt.onlinerecognition.common.data.entity.View;
...
public class User extends AbstractNamedEntity implements HasEmail, Serializable {
    ...
    @Fetch(FetchMode.SUBSELECT)
    @BatchSize(size = 200)
    private Set<Long> adverts = new HashSet<>();
    ...
    public Set<Long> getAdverts() {
        return adverts;
    }

    public void setAdverts(Set<Long> adverts) {
